  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Brand variants for Azarus
        gradient: "bg-hero-gradient text-white hover:shadow-xl hover:scale-105 shadow-lg transition-all duration-300",
        "gradient-outline": "border-2 border-transparent bg-clip-padding text-primary hover:bg-primary/5 transition-all duration-300",
        hero: "bg-hero-gradient text-white hover:shadow-xl hover:scale-105 font-semibold shadow-lg",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft",
        navy: "bg-brand-navy text-white hover:bg-brand-navy/90 shadow-soft",
      },
      size: {
